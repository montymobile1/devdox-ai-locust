...
class TestAIEnhancementConfig:
    ...
    def test_default_config(self):
        ...
        assert config.enhance_test_data is False
        assert config.enhance_validation is False
        assert config.create_domain_flows is False
...
class TestHybridLocustGenerator:
    ...
    def test_init_default(self):
        ...
        assert hasattr(generator, 'template_generator')
        assert generator.enhancement_cache == {}
    ...
    def test_should_enhance_enough_endpoints(self, sample_endpoints):
    ...
    def test_should_enhance_complex_endpoints(self, sample_api_info):
    ...
    def test_should_enhance_domain_patterns(self, sample_api_info):
    ...
    def test_should_not_enhance_simple_case(self):
    ...
    def test_detect_domain_patterns_ecommerce(self, sample_endpoints):
    ...
    def test_detect_domain_patterns_user_management(self, sample_endpoints):
    ...
    def test_detect_domain_patterns_no_match(self):
    ...
    def test_format_endpoints_for_prompt(self, sample_endpoints):
    ...
    def test_analyze_api_domain(self, sample_endpoints, sample_api_info):
    ...
    def test_extract_resources_from_paths(self):
...
class TestHybridLocustGeneratorAsync:
    ...
    async def test_generate_from_endpoints_template_only(
        ...
        with patch.object(generator.template_generator, 'generate_from_endpoints') as mock_generate:
    ...
    async def test_generate_from_endpoints_with_ai(
        ...
        with patch.object(generator.template_generator, 'generate_from_endpoints') as mock_generate, \
            ...
            mock_enhance.return_value = EnhancementResult(
                ...
                enhanced_directory_files=[{"enhanced_workflow.py": "# Enhanced workflow"}],
    ...
    @pytest.mark.asyncio
    async def test_enhance_locustfile(self, mock_together_client, sample_endpoints, sample_api_info):
    ...
    @pytest.mark.asyncio
    async def test_generate_domain_flows(self, mock_together_client, sample_endpoints, sample_api_info):
        ...
        with patch.object(generator, '_call_ai_service') as mock_ai_call, \
            ...
            result = await generator._generate_domain_flows(sample_endpoints, sample_api_info)
...
class TestEnhancementProcessor:
    ...
    @pytest.mark.asyncio
    async def test_process_main_locust_enhancement(self, sample_endpoints, sample_api_info):
    ...
    @pytest.mark.asyncio
    async def test_process_domain_flows_enhancement(self, sample_endpoints, sample_api_info):
...
"""
    ...
    def test_extract_schema_patterns(self, sample_endpoints):
    ...
    def test_extract_validation_patterns(self, sample_endpoints):
...
class TestHybridLocustGeneratorFileOperations:
    ...
    @pytest.mark.asyncio
    async def test_create_test_files_safely_success(self, temp_dir, sample_generated_files):
    ...
    @pytest.mark.asyncio
    async def test_create_test_files_safely_empty_files(self, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_create_test_files_safely_with_errors(self, temp_dir):
...
class TestHybridLocustGeneratorEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_generate_from_endpoints_exception(self, sample_endpoints, sample_api_info):
        ...
        def mock_generate_side_effect(*args, **kwargs):
            nonlocal call_count
            call_count += 1
            print(f"Mock called {call_count} times with args: {len(args)}, kwargs: {kwargs}")
        ...
        with patch.object(generator.template_generator, 'generate_from_endpoints', side_effect=mock_generate_side_effect):
            ...
            print("workflows ", workflows, type(workflows))
    ...
    @pytest.mark.asyncio
    async def test_generate_from_endpoints_complete_failure(self, sample_endpoints, sample_api_info):
    ...
    async def test_ai_enhancement_with_all_features_enabled(
        ...
        with patch.object(generator, '_call_ai_service') as mock_ai_call:
            ...
            result = await generator._enhance_with_ai(
                base_files, sample_endpoints, sample_api_info,
                directory_files, grouped_endpoints
            )
            
            assert result.success is True
            assert len(result.enhancements_applied) > 0

    def test_setup_jinja_env(self):
