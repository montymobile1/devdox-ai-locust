...
"""
    ...
    def test_generate_from_endpoints(self, sample_endpoints, sample_api_info):
        ...
        with patch.object(generator, '_group_endpoints_by_tag') as mock_group, \
            ...
            expected_files = [
                "locustfile.py", "test_data.py", "config.py", "utils.py",
                "custom_flows.py", "requirements.txt", "README.md", ".env.example"
            ]
    ...
    def test_generate_path_params_code(self):
        ...
        endpoint.parameters = [
            ...
            SimpleNamespace(name="username", location=ParameterType.PATH, type="string"),
        ]
    ...
    def test_generate_query_params_code(self):
        ...
        endpoint = Mock()
        endpoint.parameters = [
            Mock(name="limit", location=ParameterType.QUERY, type="integer", required=True, default=None),
            Mock(name="filter", location=ParameterType.QUERY, type="string", required=False, default="active")
        ]
    ...
    def test_generate_request_body_code_json(self):
        ...
        endpoint.request_body.schema = {"type": "object", "properties": {"name": {"type": "string"}}}
    ...
    def test_generate_main_locustfile(self, mock_task_method, sample_endpoints, sample_api_info):
    ...
    def test_generate_workflows(self, sample_endpoints, sample_api_info):
        ...
        grouped_endpoints = {"users": sample_endpoints[:2], "auth": sample_endpoints[2:]}
        
        with patch.object(generator, '_generate_task_method') as mock_task, \
...
class TestLocustTestGeneratorEdgeCases:
    ...
    def test_generate_from_endpoints_empty_list(self, sample_api_info):
        ...
        files, workflows, grouped = generator.generate_from_endpoints([], sample_api_info)
