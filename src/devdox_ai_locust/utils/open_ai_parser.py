...
class OpenAPIParser:
    ...
    def _extract_parameters(self, operation: Dict[str, Any], path_parameters: List[Dict] = None) -> List[Parameter]:
        """
    ...
    def _resolve_reference(self, obj: Union[Dict[str, Any], str]) -> Optional[Dict[str, Any]]:
        """
